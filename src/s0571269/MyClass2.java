...
public class MyClass2 extends AI {
...
//    long startTime = System.nanoTime();
    ...
    public MyClass2(lenz.htw.ai4g.ai.Info info) {
        super(info);
...
//    	    }
        ...
        prevPosInterval++;
        if (prevPosInterval % 5 == 0) {//TODO time 2 sec?
            prevPosInterval = 0;
            prevPos = new Point((int) info.getX(), (int) info.getY());
        }
...
//if obstructed by ob and not super close to curCheck
        ...
        spinPosInterval++;
        if (spinPosInterval % 40 == 0) {//TODO time
