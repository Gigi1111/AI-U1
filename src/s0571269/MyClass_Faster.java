...
//
//public class MyClass_Faster extends AI {
//
//    // max 1 min -1
//    float angularAcc;
//    float throttle;
...
//    
//    Point prevPos = null;
//    public MyClass_Faster(lenz.htw.ai4g.ai.Info info) {
//	   	 super(info);
...
//	    
//	    
//	    Point curNode = info.getCurrentCheckpoint();
//	    
//	      //check if getting further away, init again
////	    prev position is closer to checkpoint then currenct
//	    int buffer = 0;
//	    if(distance(prevPos,curNode)+buffer<distance(null,curNode) || distance(currentPosition,prevPos)<0.5 ) {// || distance(prevPos,p)==distance(null,p)) {
//	    	initGraph();
//	    	listPointCounter=1;	
//	    }
//	    //
...
//	    return new DriverAction(acceleration(arrive(3f,50f)),newAV);
//	    
...
//    				
//	    				g.addPoint(pointPlusBuffer(obs[i],j,2));
